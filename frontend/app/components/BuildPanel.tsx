...
export default function BuildPanel({ isOpen, onClose }: BuildPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none p-2 sm:p-4">
      <div className="panel-glass rounded-2xl p-3 sm:p-6 w-full max-w-2xl min-w-[280px] shadow-2xl pointer-events-auto border-2 border-accent-blue/50 max-h-[90vh] overflow-y-auto">
