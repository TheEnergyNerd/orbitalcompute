  ...
  return (
    <>
      ...
      <button
        ...
        className={`sm:hidden fixed bottom-28 right-4 z-50 w-14 h-14 bg-accent-blue hover:bg-accent-blue/80 text-dark-bg rounded-full font-semibold text-xl transition-all shadow-lg flex items-center justify-center ${
